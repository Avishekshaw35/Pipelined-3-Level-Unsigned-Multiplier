...
HD_PWD='C:/Users/user/Desktop/programming/VLSI_MODULE/Multiplier/Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pipelined_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pipelined_Multiplier.tcl
